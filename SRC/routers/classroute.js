...
router.post('/create', authAndverfication,  middleware.classfields, set.usertype_and_nclass, createClass);
...
//test this end point
router.post('/unenrol',authAndverfication,middleware.classid,);
...
//test this end point
router.post('/c/ficher/view',authAndverfication,middleware.classid,ficherview);
